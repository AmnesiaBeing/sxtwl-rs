...
impl Phenology {
    ...
    pub fn get_julian_day(&self) -> JulianDay {
        let t: f64 = Sxtwl::sa_lon_t(
            (self.get_year() as f64 - 2000f64
                + (self.get_index() as f64 - 18f64) * 5.0 / 360f64
                + 1f64)
                * 2f64
                * PI,
        );
        JulianDay::from_julian_day(t * 36525f64 + J2000 + 8.0 / 24f64 - Sxtwl::dtt(t * 36525f64))
    }
}
...
mod tests {
    ...
    use crate::culture::phenology::{Phenology, PhenologyDay, ThreePhenology};
