...
use crate::culture::Direction;
use crate::enums::Side;
use crate::lunar::{LunarDay, LunarMonth};
use crate::sixtycycle::{SixtyCycle, SixtyCycleDay};
use crate::types::{Culture, LoopTyme, Tyme};
...
impl FetusDay {
    pub fn new(sixty_cycle: SixtyCycle) -> Self {
        ...
        let index: isize = [
            3, 3, 8, 8, 8, 8, 8, 1, 1, 1, 1, 1, 1, 6, 6, 6, 6, 6, 5, 5, 5, 5, 5, 5, 0, 0, 0, 0, 0,
            -9, -9, -9, -9, -9, -5, -5, -1, -1, -1, -3, -7, -7, -7, -7, -5, 7, 7, 7, 7, 7, 7, 2, 2,
            2, 2, 2, 3, 3, 3, 3,
