...
/// 每天文单位的光行时间（儒略世纪）
pub const LIGHT_TIME_PER_AU_CENTURIES: f64 =
    ASTRONOMICAL_UNIT_KM / SPEED_OF_LIGHT_KM_PER_SEC / SECONDS_PER_DAY / JULIAN_CENTURY_DAYS;
...
/// 月球视半径计算常数（角秒）
pub const LUNAR_APPARENT_RADIUS: f64 =
    MOON_EARTH_RADIUS_RATIO_PENUMBRA * EARTH_EQUATORIAL_RADIUS_KM * 1.0000036 * RAD;

/// 月球视半径计算常数（本影，角秒）
pub const LUNAR_APPARENT_RADIUS_UMBRA: f64 =
    MOON_EARTH_RADIUS_RATIO_UMBRA * EARTH_EQUATORIAL_RADIUS_KM * 1.0000036 * RAD;
