    ...
    pub fn get_fetal_breath(&self) -> SixtyCycle {
        ...
        SixtyCycle::from_name(
            format!(
                ...
                EarthBranch::from_index(13 - (d.get_earth_branch().get_index() as isize))
                    .get_name()
            )
            .as_str(),
        )
...
impl ChildLimit {
    ...
    pub fn get_end_age(&self) -> usize {
        let n: isize = self.get_end_sixty_cycle_year().get_year()
